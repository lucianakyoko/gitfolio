  ...
  return (
    <section id="templates" className="scroll-mt-6">
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm">
        <p className="mb-4">
          O GitFolio oferece diversos modelos para exibir seu portfólio com estilos visuais variados. Você pode escolher um durante a criação do portfólio ou atualizando a configuração no seu repositório GitFolio.
        </p>
