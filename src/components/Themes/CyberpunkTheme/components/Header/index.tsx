      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
          ...
          <div className="md:col-span-8">
            <div className="bg-black/70 backdrop-blur-sm border border-cyan-500/30 p-6 rounded-md">
              <div className="flex items-center mb-3">
                <Terminal className="text-pink-500 mr-2 h-5 w-5" />
                <div className="text-xs text-cyan-300">usr {'>>'} profile {'>>'} data</div>
              </div>
