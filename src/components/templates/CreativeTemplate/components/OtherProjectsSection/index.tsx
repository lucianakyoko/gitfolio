          ...
          <CarouselItem className="md:basis-1/2 lg:basis-1/3">
            <Card className="h-full group hover:shadow-md transition-all duration-300 border-0">
              <div className="h-40 overflow-hidden rounded-t-lg">
                <img 
                  src="https://images.unsplash.com/photo-1744614053463-491122164435?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                  alt=""
