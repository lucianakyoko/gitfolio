...
export default function UserPage() {
  ...
  if (isLoading) return (
    <div className="w-full h-dvh bg-blue-50 flex flex-col gap-8 justify-center items-center">
      ...
      <p>Carregando Gitfollio de <span className="font-bold">{user}</span>...</p>
    </div>
  );
  ...
  if (isError) return (
    <div className="w-full h-dvh bg-blue-50 flex flex-col gap-8 justify-center items-center">
      ...
      <p>Erro ao carregar Gitfollio de <span className="font-bold">{user}</span></p>
    </div>
  );
  ...
  if (!portfolio || portfolio.gitfolio === "off") return (
    <div className="w-full h-dvh bg-blue-50 flex justify-center items-center">
      <div className="flex flex-col gap-4 items-center">
        <p>Gitfollio de <span className="font-bold">{user}</span> não configurado.</p>
        <NextLink 
          href='/'
